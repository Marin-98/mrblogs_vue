...
<template>
    <div class="rightlistBox">
        <section >
            <div class="r1-head">
                <img :src="this.$store.state.themeObj.center_smailimg?this.$store.state.themeObj.center_smailimg:'../img/banner.png'" alt="">
                ...
                <div class="catch-me" >
                    <div class="">
                        <el-tooltip  class="item"  content="Github" placement="top" >
                            <a  :href="catchMeObj[isMarin].git" target="_blank" ><i class="fa fa-fw fa-github"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="QQ" placement="top">
                            <a  :href="catchMeObj[isMarin].qq" target="_blank"><i class="fa fa-fw fa-qq"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="微博" placement="top">
                            <a :href="catchMeObj[isMarin].sina" target="_blank"><i class="fa fa-fw fa-weibo"></i></a>
                        </el-tooltip>
                    </div>
                    <div class="">
                        <el-tooltip class="item" effect="dark" content="微信" placement="top">
                            <a :href="catchMeObj[isMarin].wechat" target="_blank"><i class="fa fa-fw fa-wechat"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="CSDN" placement="top">
                            <a :href="catchMeObj[isMarin].csdn" target="_blank"><i class="">C</i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="简历" placement="top">
                            <a :href="catchMeObj[isMarin].job" target="_blank"><i class="fa fa-fw fa-file-word-o"></i></a>
                        </el-tooltip>
                ...
                <li class="rs3-item" v-for="(item,index) in artCommentList" :key="'artCommentList'+index">
                    <a :href="'#/DetailShare?aid='+item.id" target="_blank">
                        ...
                        <div class="rs3-inner">
                            ...
                            <p class="rs3-text">{{item.comment}}</p>
                        </div>
                    </a>
                </li>
            </ul>
        ...
        <section class="rs4">
            ...
            <ul>
                <li v-for="(item,index) in browseList" :key="'browseList'+index">
                    <a :href="'#/DetailShare?aid='+item.id" target="_blank">{{item.title}}</a> —— {{item.browsecount}} 次围观
                </li>
            </ul>
        </section>
        <!-- 右侧上滑小图片 -->
        <div  v-if="this.$store.state.themeObj.user_start!=0" :class="gotoTop?'toTop hidden':'toTop goTop hidden'" @click="toTopfun">
            <img :src="this.$store.state.themeObj.right_img?this.$store.state.themeObj.right_img:'../img/scroll.png'" alt="">
        </div>
    ...
    export default {
        data() { //选项 / 数据
            return {
                ...
                catchMeObj:{//抓住我 个人信息
                    Marin:{
                        git:'https://github.com/Marin-98',
                        qq: 'http://110.42.223.135:8091/Marin/qq.png',
                        sina: 'http://110.42.223.135:8091/Marin/sina.png',
                        wechat: 'http://110.42.223.135:8091/Marin/wechat.jpg',
                        csdn: 'https://blog.csdn.net/qq_27493225?type=sub&subType=fans&spm=1008.2028.3001.5347',
						job:'http://www.mrblogs.top:8082/'
                    }
                },
                isMarin:this.$store.state.themeObj.user_start!=1?"Marin":""//判断是哪个的博客
            }
        },
        methods: { //事件处理器
            //do you love me  点击
