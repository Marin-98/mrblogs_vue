...
<template>
    <div class="tRewardBox tcommonBox">
        ...
        <section>
            <div class="">
                <img src="../../public/img/timg.jpg" alt="" class="maxW" >
            </div>
            <hr>
            <h1>@赞赏方式：</h1>
            <el-row   :gutter="30">
                <el-col  :span="12"   class="donate-item">
                    <div class="donate-tip">
                        <img :src="rewardData.wechat_image?rewardData.wechat_image:'../img/tou.jpg'" :onerror="$store.state.errorImg">
                        <span>微信扫一扫，向我赞赏</span>
                    </div>
                </el-col>
                <el-col :span="12"  class="donate-item">
                    <div class="donate-tip">
                        <img :src="rewardData.alipay_image?rewardData.alipay_image:'../img/tou.jpg'" :onerror="$store.state.errorImg">
