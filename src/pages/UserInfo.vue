                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <img v-if="userInfoObj.avatar" :src="userInfoObj.avatar?wwwHost+userInfoObj.avatar:'../img/tou.jpg'"   :onerror="$store.state.errorImg" class="avatar">
                        ...
                        <li  v-show="state" class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <img v-if="userInfoObj.image" :src="userInfoObj.image?wwwHost+userInfoObj.image:'../img/tou.jpg'"  :onerror="$store.state.errorImg"  class="avatar">
                              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                              <div slot="tip" class="el-upload__tip">点击上传头像，只能上传jpg/png文件，且不超过1mb</div>
                            </el-upload>
                        </li>
                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <div class="avatar-uploader">
                                <img  :src="userInfoObj.avatar?userInfoObj.avatar:'../img/tou.jpg'"   :onerror="$store.state.errorImg" class="avatar">
                            </div>
                        </li>
                        <li class="username">
                            <span class="leftTitle">昵称</span>
                        ...
                        <li>
                            <span class="leftTitle">性别</span>
                            <span>{{userInfoObj.sex==1?'女':'男'}}</span>
                        </li>
                        <li>
                            <span class="leftTitle">个性标签</span>
                        ...
                        <li  class="avatarlist">
                            <span class="leftTitle">网站logo</span>
                            <div class="avatar-uploader">
                                <img  :src="userInfoObj.image?userInfoObj.image:'../img/tou.jpg'"  :onerror="$store.state.errorImg"  class="avatar">
                            </div>
                        </li>
                    </ul>
